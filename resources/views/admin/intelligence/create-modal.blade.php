<div id="create-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-lg max-h-full p-4">
        ...
        <div class="relative bg-white rounded-lg shadow-lg">
            ...
            <!-- Modal body -->
            <form id="formCreate" action="{{ route('intelligence.store') }}" method="POST">
                @csrf
                <div class="p-4 space-y-4 md:p-5">
                    <!-- Intelligence Name -->
                    <div>
                        <label for="intelligence-name" class="block mb-2 text-sm font-medium text-gray-900">
                            Intelligence Name <span class="text-red-500">*</span>
                        </label>
                        <input type="text" name="name" id="intelligence-name"
                    ...
                    <!-- Description -->
                    <div>
                        <label for="intelligence-description" class="block mb-2 text-sm font-medium text-gray-900">
                            Description
                        </label>
                        <textarea name="description" id="intelligence-description" rows="4"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Enter intelligence description"></textarea>
                    </div>
                </div>
