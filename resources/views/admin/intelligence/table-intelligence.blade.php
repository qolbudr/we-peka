<table id="intelligence-table" class="w-full">
    ...
    <tbody class="divide-y divide-gray-200">
        @forelse ($intelligences as $intel)
            <tr class="bg-white">
                ...
                <td class="px-4 py-4 sm:px-6">
                    <div class="flex items-center justify-center gap-2">
                        <!-- Button Edit -->
                        <button data-modal-target="edit-modal_{{ $intel->id }}"
                            data-modal-toggle="edit-modal_{{ $intel->id }}"
                        ...
                        {{-- Modal Edit --}}
                        @include('admin.intelligence.edit-modal')

                        <!-- Button Delete -->
                        <button type="button" data-url="{{ route('intelligence.destroy', $intel->id) }}"
            ...
            <tr>
                <td colspan="5" class="p-0">
                    <div
                        ...
                        <p class="text-lg font-semibold text-gray-700">No intelligence found</p>
                        <p class="mt-1 text-sm text-gray-500">Get started by creating your first intelligence.</p>
                    </div>
                </td>
            </tr>
        @endforelse
