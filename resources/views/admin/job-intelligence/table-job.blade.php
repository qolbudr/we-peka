            ...
            <tr class="bg-white">
                ...
                <td class="px-4 py-4 sm:px-6">
                    <div class="flex items-center justify-center gap-2">
                        <!-- Button Edit -->
                        <button data-modal-target="edit-modal_{{ $job->id }}"
                            data-modal-toggle="edit-modal_{{ $job->id }}"
                        ...
                        {{-- Modal Edit --}}
                        @include('admin.job-intelligence.edit-modal')

                        <!-- Button Delete -->
                        <button type="button" data-url="{{ route('job-intelligence.destroy', $job->id) }}"
            ...
            <tr>
                <td colspan="4" class="p-0">
                    <div
                        ...
                        <p class="text-lg font-semibold text-gray-700">No job intelligence found</p>
                        <p class="mt-1 text-sm text-gray-500">Get started by creating your first job intelligence.</p>
                    </div>
                </td>
            </tr>
        @endforelse
