            ...
            <tr class="bg-white">
                ...
                <td class="px-4 py-4 sm:px-6">
                    <div class="flex items-center justify-center gap-2">
                        <!-- Button Edit -->
                        <button data-modal-target="edit-modal_{{ $quest->id }}"
                            data-modal-toggle="edit-modal_{{ $quest->id }}"
                        ...
                        {{-- Modal Edit --}}
                        @include('admin.question.edit-modal')

                        <!-- Button Delete -->
                        <button type="button" data-url="{{ route('question.destroy', $quest->id) }}"
