    ...
    <div class="p-4 mt-20 rounded-lg">
        ...
        <div class="mb-6">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 sm:text-3xl">Guru</h1>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-auto rounded-2xl">
            <table id="guru-table" class="w-full overflow-auto rounded-lg">
                        ...
                        <tr>
                            <td colspan="5" class="p-0">
                                <div
                                    ...
                                    <p class="text-lg font-semibold text-gray-700">No Guru found</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
