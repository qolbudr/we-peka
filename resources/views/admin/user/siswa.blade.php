    ...
    <div class="p-4 mt-20 rounded-lg">
        ...
        <div class="mb-6">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 sm:text-3xl">Siswa</h1>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-auto rounded-2xl">
            <table id="siswa-table" class="w-full overflow-auto rounded-lg">
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse ($siswa as $item)
                        <tr class="bg-white">
                            ...
                            <td class="px-4 py-4 text-gray-900 sm:px-6">
                                {{ ucwords(str_replace('-', ' ', strtolower($item->gender->value))) }}
                            </td>
                            <td class="max-w-xs px-4 py-4 text-gray-900 sm:px-6">
                                {{ $item->phone ?? '-' }}
                            </td>
                        ...
                        <tr>
                            <td colspan="5" class="p-0">
                                <div
                                    ...
                                    <p class="text-lg font-semibold text-gray-700">No Siswa found</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
