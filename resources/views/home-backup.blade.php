...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body
        ...
        <div
            ...
            <main
                class="flex flex-col-reverse w-full max-w-xl py-20 border bg-zinc-950 border-zinc-800 lg:flex-row rounded-2xl">
                <div class="mx-auto text-6xl font-semibold text-white">
                    DANCOK KOE LET
                </div>
            </main>
        </div>
